...
<?php
  if ($acl['fid'] == -1) {
?>
  <td>All Forums [<a href="useracldelete.phml?aid=<?php echo $aid; ?>&fid=<?php echo $acl['fid']; ?>]</td>
<?php
  } else {
?>
  <td>Forum <?php echo $acl['fid']; ?> [<a href="useracldelete.phml?aid=<?php echo $aid; ?>&fid=<?php echo $acl['fid']; ?>]</td>
<?php
  }
?>
 </tr>
