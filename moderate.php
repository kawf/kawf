...
$sql = "update messages$index set state = 'Moderated' where mid = '" . addslashes($mid) . "'";
mysql_query($sql) or sql_error($sql);

$sql = "update indexes set $state = $state - 1, moderated = moderated + 1 where iid = $index";
mysql_query($sql) or sql_error($sql);

Header("Location: " . $page);
?>

Message <?php echo $mid; ?> has been moderated
