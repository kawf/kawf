...
<tr class="input">
  <th>Image Upload:</th>
  <td><input class="text" type="file" name="imagefile" onchange="if (this.files && this.files[0] && this.files[0].size > (1024 * 1024 * 10)) { alert('Image upload cannot exceed 10mb'); this.value = ''; }"></td>
</tr>
<!-- END imageupload -->
<tr class="input">
  <th>Video URL:</th>
